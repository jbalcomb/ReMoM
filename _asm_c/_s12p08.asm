...
; But for a 32-bit value x, the whole expression (x << 12) | (x >> 20),
;   consisting of two shifts (one left, one right) and a bitwise OR, has the same effect than a rotation of a 32-bit word (here, by 12 bits to the left).
;
