...
protected:
    void SetUp() override
    {
        ...
        // CLAUDE  Wire the int16_t (word-strided) view that Square_Food2_NewGame actually reads
        // (p_world_map[wp][wy][wx]).  Without this p_world_map is NULL -> SEH 0xc0000005 on every test.
