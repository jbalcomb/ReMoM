...
*/
    ...
    */
    ...
    _ai_reevaluate_continents_countdown   = ( (int8_t *) ( (void *) (&_players[5].spells_list[0]) ) + (0x17E8 - 0x1800) );  // 16 bytes
    ...
    _ai_reevaluate_summoning_circle_countdown = ( (int16_t *) ( (void *) (&_players[5].spells_list[0]) ) + 0x70              );  // &spells_list[224] = _players[5]+0x344 (OG)
