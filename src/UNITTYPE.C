...
¿ 2 character abreviations for race names ?
...from table in release notes for v1.2?
...
/*                                      name,  mel, rng, rt, amm, hit, def, res, mov, cos, upk, rac, bl1, bl2,   pict, hp, sco, tra, fig, con, spec,   mvfl,   att1,   att2,    abl,   atfl, snd */
/* clangd changed the column alignment             name,         mel,         rng,              rt,      amm, hit, def, res, mov, cos, upk, rac, bl1, bl2,   pict, hp, sco, tra, fig, con, spec,   mvfl,   att1,   att2,    abl,   atfl, snd */
...
/* 49    Engineers */ {&_unit_type_names[49],    2,  0,  -1,   0,   0,   1,   5,   2,  60,   2,   1,  32,   0, 0x0000,  2,   1,   0,   6,   1,    0, 0x0000, 0x8000, 0x0000, 0x0008, 0x0000, 0}, 
...
/* 49    Engineers */ {&_unit_type_names[49],    1,  0,  -1,   0,   0,   1,   8,   2,  40,   2,   4,  32,   0, 0x0000,  3,   1,   0,   6,   2,    0, 0x0040, 0x8000, 0x0000, 0x0008, 0x0000, 0}, 
...
/* Phantom Warriors */  {&_unit_type_names[115],   3,  0,  -1,   0,   0, 0, 6, 2, 20, 2, 17, 6, 0, 0x0000, 1, 1, 0, 6, 0, 0, 0x0000, 0x00C2, 0x0000, 0x0801, 0x0040, 0}, 
...
{&_unit_type_names[120],   4,  0,  -1,   0,   1, 3, 7, 2, 120, 2, 17, 6, 0, 0x0000, 6, 1, 0, 2, 0, 4, 0x0004, 0x0000, 0x0000, 0x0001, 0x0006, 0}, 
};
