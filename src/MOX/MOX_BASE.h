...
#define LEN_BUILDING_NAME_26     26  /* WTF, Mate? */
...
#define LEN_ITEM_NAME         30    /* array is 30, but last 4 are always 0, longest name is 26 characters */
