...
struct s_Field
{
    ...
    union {
        int16_t Param0;
        char * string;              //  4  ft_input         10  ft_StringList11  ft_ContinuousStringInput
    ...
    union {
        ...
        int16_t set_value;          // 10  ft_StringList
    ...
    union {
        ...
        int16_t fill_param3;        // 10 ft_StringList
    };
    union {
        int16_t Param6;
        ...
        int16_t fill_param4;        // 10 ft_StringList
    };
...
// WZD dseg:829E
extern char str_empty_string__seg036[];
