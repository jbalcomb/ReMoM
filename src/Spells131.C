...
{
    char * Target_Name_Ptr_List[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
    int16_t Target_BU_List[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
    ...
    if(Target_Count > 0)
    {
        ...
        else
        {
            ...
            else
            {
                if(Target_Count < 7)
                {
                    Selection_Box(Target_Count, &Target_Name_Ptr_List[0], 0, cnst_RaiseDead_Msg);  // "Select a unit to Raise"
                }
                else
                {
                    Selection_Box(6, &Target_Name_Ptr_List[0], 1, cnst_RaiseDead_Msg);  // "Select a unit to Raise"
                }
            }
