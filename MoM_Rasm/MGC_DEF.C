...
char cnst_HOTKEY_Esc = 27;
char g_LbxNm_TERRSTAT[] = "TERRSTAT";       // dseg:28D2
...
int GAME_FirstShownCred = 0;            // dseg:38D8
int GAME_CreditTextTop = 0;             // dseg:38DA
int GAME_CredsRollTimer = 0;            // dseg:38DC
...
char cnst_Credits_DOT = '.'; // dseg:3BEB
// dseg:3BED align 2
...
int g_GUI_MainScreenJump;                   // dseg:52FC  XREF: GAME_MainMenu(), SCREEN_Menu(), SCREEN_LoadSave()
int g_GAME_ValidSaveCount;                  // dseg:52FE
int g_GAME_ValidSaves_Main[8];              // dseg:5300

// TODO(JimBalcomb): figure out what this is for and where it belongs in the code-base
int g_ScreenChangeFade; // dseg:64AE

unsigned int gsa_GUI_Credits_Text_IMG; // dseg:948C
