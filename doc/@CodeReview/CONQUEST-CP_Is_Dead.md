...
- [`Resolve_Wizard_Conquest`](../../MoM/src/CONQUEST.c#L191) — sole caller; invokes `CP_Is_Dead` at [440](../../MoM/src/CONQUEST.c#L440) on the non-human-conquest branch to gate `GAME_PlayVictoryAnim__STUB(_current_player_idx)`.
