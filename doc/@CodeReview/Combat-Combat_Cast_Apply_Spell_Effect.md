...
| --- | --- | --- | --- | --- |
| `Combat_Cast_Apply_Spell_Effect` | [Combat.c:9473](../../MoM/src/Combat.c#L9473) | `ovr111/Cast_Spell_On_Battle_Unit.asm` | 1806 | **full body walk — faithful** |
| `Combat_Cast_Dispel` | [Spells131.c:270](../../MoM/src/Spells131.c#L270) | `ovr131/Cast_Dispel_Magic.asm` | 1499 | **full body walk — faithful** |
| `Combat_Cast_Disenchant` | [Spells131.c:68](../../MoM/src/Spells131.c#L68) | `ovr131/Cast_Disenchant.asm` | 693 | **full body walk — faithful** |
| `Apply_Warp_Creature` | [Spells133.c:93](../../MoM/src/Spells133.c#L93) | `ovr133/Apply_Warp_Creature.asm` | 129 | **full body walk — faithful** |
| `Apply_Cracks_Call` | [Spells131.c:643](../../MoM/src/Spells131.c#L643) | `ovr131/Apply_Cracks_Call.asm` | 109 | **full body walk — faithful** |
| `Apply_Life_Drain` | [Spells133.c:286](../../MoM/src/Spells133.c#L286) | `ovr133/BU_LifeDrain__WIP.asm` | 95 | **full body walk — faithful** |
| `Apply_Earth_To_Mud` | [Combat.c:21876](../../MoM/src/Combat.c#L21876) | `ovr154/Apply_Earth_To_Mud.asm` | 93 | **full body walk — faithful** |
| `Magic_Vortex_Create` | [Spells133.c:1023](../../MoM/src/Spells133.c#L1023) | `ovr133/Magic_Vortex_Create.asm` | 54 | **full body walk — faithful** |
| `Spell_Resistance_Modifier` | [CMBMAGIC.c:1408](../../MoM/src/CMBMAGIC.c#L1408) | `ovr112/Spell_Resistance_Modifier.asm` | 94 | **full body walk — faithful** |
...
### `Spell_Resistance_Modifier` ([CMBMAGIC.c:1408](../../MoM/src/CMBMAGIC.c#L1408), asm 94)
...
### `Combat_Cast_Dispel` ([Spells131.c:270](../../MoM/src/Spells131.c#L270), asm 1499)
