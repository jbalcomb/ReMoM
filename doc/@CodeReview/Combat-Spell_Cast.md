...
| `Do_Legal_Spell_Check` | [CMBMAGIC.c:1081](../../MoM/src/CMBMAGIC.c#L1081) | `ovr112/Do_Legal_Spell_Check__WIP.asm` | 767 | **full body walk — faithful** |
| `Combat_Cast_Spell_Message` | [Combat.c:11894](../../MoM/src/Combat.c#L11894) | `ovr113/Combat_Cast_Spell_Message.asm` | 276 | **full body walk — faithful** |
| `Combat_Cast_Spell_With_Caster` | [Combat.c:6805](../../MoM/src/Combat.c#L6805) | `ovr103/zCombat_Cast_Spell_With_Caster.asm` | 111 | **full body walk — faithful** |
| `Combat_Casting_Cost_Multiplier` | [CMBMAGIC.c:1443](../../MoM/src/CMBMAGIC.c#L1443) | `ovr112/Combat_Casting_Cost_Multiplier.asm` | 109 | **full body walk — faithful** |
| `Combat_Cast_Spell_Error` | [Combat.c:6591](../../MoM/src/Combat.c#L6591) | `ovr103/zCombat_Cast_Spell_Error.asm` | 26 | **full body walk — faithful** |
...
- [Combat_Cast_Apply_Spell_Effect](../../MoM/src/Combat.c#L9473) — applies the chosen spell ([747](../../MoM/src/CMBMAGIC.c#L747)).
...
### `Combat_Cast_Spell_With_Caster` ([Combat.c:6805](../../MoM/src/Combat.c#L6805), asm 111)
...
### `Combat_Cast_Spell_Error` ([Combat.c:6591](../../MoM/src/Combat.c#L6591), asm 26)
...
### `Combat_Casting_Cost_Multiplier` ([CMBMAGIC.c:1443](../../MoM/src/CMBMAGIC.c#L1443), asm 109)
...
### `Combat_Cast_Spell_Message` ([Combat.c:11894](../../MoM/src/Combat.c#L11894), asm 276)
...
### `Do_Legal_Spell_Check` ([CMBMAGIC.c:1081](../../MoM/src/CMBMAGIC.c#L1081), asm 767)
