...
| --- | --- | --- | --- | --- |
| `Combat_Spell_Target_Screen` | [Combat.c:10334](../../MoM/src/Combat.c#L10334) | `ovr113/Combat_Spell_Target_Screen__WIP.asm` | 1,414 | **full body walk — faithful** |
| `Combat_Screen_Assign_Mouse_Images` | [Combat.c:10147](../../MoM/src/Combat.c#L10147) | `ovr113/Combat_Screen_Assign_Mouse_Images.asm` | 273 | **full body walk — faithful** |
| `Combat_Spell_Target_Screen_Draw` | [Combat.c:10315](../../MoM/src/Combat.c#L10315) | `ovr113/Combat_Spell_Target_Screen_Draw.asm` | 68 | **full body walk — faithful** |
...
**The tile accept takes `COMBAT_CELL_NO_ACTION` squares and never range-checks the cell.** The test is `target_idx < 0`, which covers both `-1` (`COMBAT_CELL_REACHABLE`) and `-2` (`COMBAT_CELL_NO_ACTION`, the fill value from [Combat.c:2888](../../MoM/src/Combat.c#L2888)); and [Get_Combat_Grid_Cell_X](../../MoM/src/Combat.c#L21903) does raw arithmetic with no clamping, so the map read at [Combat.c:10987](../../MoM/src/Combat.c#L10987) can index outside the 21x22 grid. [Combat.c:10997](../../MoM/src/Combat.c#L10997).
...
### `Combat_Spell_Target_Screen_Draw` ([Combat.c:10315](../../MoM/src/Combat.c#L10315), asm 68)
...
### `Combat_Screen_Assign_Mouse_Images` ([Combat.c:10147](../../MoM/src/Combat.c#L10147), asm 273)
...
### `Combat_Spell_Target_Screen` ([Combat.c:10334](../../MoM/src/Combat.c#L10334), asm 1,414)
