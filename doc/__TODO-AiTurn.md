...
- [ ] **4D** Specific-spell-targeting cluster: [`AITP_Change_Terrain`](../MoM/src/AISPELL.c#L550), [`AITP_Spell_Ward`](../MoM/src/AISPELL.c#L632), [`AITP_Spell_Ward`](../MoM/src/AISPELL.c#L1357)
...
- **AISPELL.c + OverSpel.c**: scoped into **Wave 4** (overland spell-AI subsystem) — `Cast_Spell_Overland`, `AI_Spell_Select`, `AITP_Change_Terrain`, `AITP_Spell_Ward`, `AITP_City_Enchantment`, `AITP_Unit_Enchantment`, `AITP_Disjunction`, `AITP_Attack_Wizard`, `AITP_Spell_Ward`, `IDK_Get_Global_Enchant_Index__STUB`
