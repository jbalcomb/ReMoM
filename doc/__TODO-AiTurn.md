...
- [ ] **5B** [`Make_Raiders`](../MoM/src/AIDATA.c#L353) + [`Make_Monsters`](../MoM/src/AIDATA.c#L124) — **partial**:
  ...
  - [ ] `Make_Monsters` ([AIDATA.c:124](../MoM/src/AIDATA.c#L124)) — body exists, no doc; still calls `Create_Unit__WIP` at [AIDATA.c:314](../MoM/src/AIDATA.c#L314).
