...
- [ ] **5C** [`NPC_Excess_Garrison`](../MoM/src/AIDATA.c#L53) + [`AI_Hopeless_Stasis`](../MoM/src/AIDUDES.c#L2168) — **partial**:
  ...
  - [ ] `AI_Hopeless_Stasis` ([AIDUDES.c:2168](../MoM/src/AIDUDES.c#L2168)) — body exists (commit `94fdf41a`), no doc.
