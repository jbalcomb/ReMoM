...
- [x] **2B** slot 2 `AI_Shift_Off_Home_Plane` ([AIMOVE.c:3348](../MoM/src/AIMOVE.c#L3348)) — covered in parent doc
- [x] **2C** slot 3 `AI_Move_Out_Boats` ([AIMOVE.c:3424](../MoM/src/AIMOVE.c#L3424)) + `AI_Stack_Set_Boats_Goto` ([AIMOVE.c:5768](../MoM/src/AIMOVE.c#L5768)) — covered in parent doc
- [x] **2D** slot 9 `AI_Find_Opportunity_City_Target` ([AIMOVE.c:3032](../MoM/src/AIMOVE.c#L3032)) — covered in parent doc (OGBUG `wp=0` stale flagged)

### Wave 3 — Pre-orders setup phase (per-AI loop body)
- [ ] **3A** [`AI_Evaluation_Map`](../MoM/src/AIMOVE.c#L6809) — body exists; foundational for downstream; **no doc, no done-done commit**
...
- [ ] **3F** Magic/gold cluster — **partial**:
  ...
  - [ ] `AI_Update_Magic_Power` ([AIDUDES.c:585](../MoM/src/AIDUDES.c#L585)) — body exists, CamelCase locals, no doc
