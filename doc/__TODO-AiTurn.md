...
- [ ] **4C** Target-picker cluster: [`AITP_City_Enchantment`](../MoM/src/AISPELL.c#L795), [`AITP_Unit_Enchantment`](../MoM/src/AISPELL.c#L1022), [`IDK_AITP_Target_Wizard__STUB`](../MoM/src/AISPELL.c#L1347), [`AITP_Disjunction`](../MoM/src/AISPELL.c#L1041) — pick who/what to cast on
- [ ] **4D** Specific-spell-targeting cluster: [`AITP_Change_Terrain`](../MoM/src/AISPELL.c#L550), [`AITP_Spell_Ward`](../MoM/src/AISPELL.c#L632), [`AITP_SpellWard_Wrapper__STUB`](../MoM/src/AISPELL.c#L1357)
...
- **AISPELL.c + OverSpel.c**: scoped into **Wave 4** (overland spell-AI subsystem) — `Cast_Spell_Overland`, `AI_Spell_Select`, `AITP_Change_Terrain`, `AITP_Spell_Ward`, `AITP_City_Enchantment`, `AITP_Unit_Enchantment`, `AITP_Disjunction`, `IDK_AITP_Target_Wizard__STUB`, `AITP_SpellWard_Wrapper__STUB`, `IDK_Get_Global_Enchant_Index__STUB`
