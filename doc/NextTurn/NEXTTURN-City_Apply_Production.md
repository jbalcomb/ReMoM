...
External calls: `City_Current_Product_Cost`, `Create_Unit`, `UNIT_RemoveExcess`, `Army_At_City`, `Set_Map_Square_Explored_Flags_XYP_Range`, `Player_Colony_Autobuild_HP`, `LBX_Load_Data_Static`, `Warn0`, `stu_strcpy`, `stu_strcat`.
