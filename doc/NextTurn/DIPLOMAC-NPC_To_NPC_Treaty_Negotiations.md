...
- Constants: `spl_Spell_Of_Return`, `DIPL_WizardPact = 1`, `DIPL_Alliance`, `DIPL_War`, `TBL_AI_PRS_IDK_Mod[]`, `m_exchange_spell_list`, `m_diplomsg_1_record_sub_number`, `_current_player_idx`, `_num_players`, `_difficulty`.
