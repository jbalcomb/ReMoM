...
This is the original reassembled code for the main() functions from both MAGIC.EXE and WIZARDS.EXE.
...
int MGC_main(int argc, char * argv[])
{
    ...
    SAMB_ptr main_menu_music_seg = 0;
    ...
    file_handle = fopen(str_CONFIG_MOM, cnst_ReadBinary);
