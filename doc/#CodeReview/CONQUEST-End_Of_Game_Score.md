...
- **SoM-winner marking** ([495-504](../../MoM/src/SCORE.c#L495-L504)) — if `GAME_SoM_Cast_By == _current_player_idx`, mark every still-active fortress's wizard into `Defeated_Wizards` (`Set_Bit_Field_Near`).
