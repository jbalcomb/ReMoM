...
| [Combat-Combat_Cast_Spell.md](Combat-Combat_Cast_Spell.md) | 8 | `Update_Combat_Enchantments_Icon_And_Help`, `Cast_Spell_On_Battle_Unit`, `Combat_Compose_Spellbook_Background`, `Do_Legal_Spell_Check__WIP`, `Combat_Casting_Cost_Multiplier`, `Combat_Spell_Target_Screen`, `AI_SelectCmbtSpell`, `AI_SetCombatRealms` |
