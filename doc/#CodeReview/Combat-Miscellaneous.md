...
| --- | --- | --- | --- | --- |
| `Update_Move_Map_City_Perimeter_Restrictions` | [Combat.c:15722](../../MoM/src/Combat.c#L15722) | `ovr124/AI_RestrictToCity__WIP.asm` | 77 | **full body walk — faithful** |
| `Get_Effective_Hits` | [Combat.c:8485](../../MoM/src/Combat.c#L8485) | `ovr110/Get_Effective_Hits.asm` | 74 | **full body walk — faithful** |
| `NIU_Enemy_Stack_Combat` | [Combat.c:3511](../../MoM/src/Combat.c#L3511) | `ovr096/UU_IDK_CMB_s7DE08.asm` | 72 | **full body walk — faithful** |
| `NIU_Combat_Redraw_Main_Screen` | [Combat.c:3569](../../MoM/src/Combat.c#L3569) | `ovr096/UU_IDK_Main_Screen_Draw.asm` | 60 | **full body walk — faithful** |
| `Combat_Grid_Screen_Coordinates` | [Combat.c:22108](../../MoM/src/Combat.c#L22108) | `ovr154/Combat_Grid_Screen_Coordinates.asm` | 44 | **full body walk — faithful** |
| `NIU_Allocate_And_Build_Battlefield` | [Combat.c:18415](../../MoM/src/Combat.c#L18415) | `ovr153/NX_IDK_CombatInit_Tactical.asm` | 19 | **full body walk — faithful** |
| `o153p22_empty_function` | [Combat.c:19852](../../MoM/src/Combat.c#L19852) | `ovr153/NX_EmptyFxn_o153p22.asm` | 7 | **full body walk — faithful** |
...
### `Get_Effective_Hits` ([Combat.c:8485](../../MoM/src/Combat.c#L8485), asm 74)

Faithful, all 74 lines. It converts a unit's per-figure hit points into an arbitrary "effective health" score scaled by defense, for the strategic-combat estimator - [Strategic_Combat](../../MoM/src/Combat.c#L7787) sums it over the attacker's units at [Combat.c:7945](../../MoM/src/Combat.c#L7945) and the defender's at [Combat.c:7968](../../MoM/src/Combat.c#L7968).
...
### `NIU_Allocate_And_Build_Battlefield` ([Combat.c:18415](../../MoM/src/Combat.c#L18415), asm 19)
...
### `o153p22_empty_function` ([Combat.c:19852](../../MoM/src/Combat.c#L19852), asm 7)
...
### `NIU_Enemy_Stack_Combat` ([Combat.c:3511](../../MoM/src/Combat.c#L3511), asm 72)
...
### `NIU_Combat_Redraw_Main_Screen` ([Combat.c:3569](../../MoM/src/Combat.c#L3569), asm 60)
