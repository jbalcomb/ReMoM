...
| --- | --- | --- | --- | --- |
| `Generate_Combat_Map` | [Combat.c:21438](../../MoM/src/Combat.c#L21438) | `ovr154/Generate_Combat_Map.asm` | 907 | **full body walk — R1-R4** |
| `Set_Terrain_Tile_Types` | [Combat.c:22678](../../MoM/src/Combat.c#L22678) | `ovr154/CMB_TileGen__WIP.asm` | 815 | **full body walk — faithful** |
| `Build_Road_Network` | [Combat.c:22166](../../MoM/src/Combat.c#L22166) | `ovr154/CMB_RoadGen.asm` | 759 | frame + walk logic + phase split |
| `Scatter_Tree_Scenery` | [Combat.c:21845](../../MoM/src/Combat.c#L21845) | `ovr154/CMB_TreeGen.asm` | 452 | frame + seed/scatter + guards |
| `Set_Movement_Cost_Maps` | [Combat.c:23119](../../MoM/src/Combat.c#L23119) | `ovr154/Set_Movement_Cost_Maps.asm` | 408 | **full body walk — faithful** |
| `Scatter_Rock_Scenery` | [Combat.c:22045](../../MoM/src/Combat.c#L22045) | `ovr154/CMB_RockGen.asm` | 341 | **full body walk — faithful** |
| `Carve_River_Terrain` | [Combat.c:22476](../../MoM/src/Combat.c#L22476) | `ovr154/CMB_RiverGen.asm` | 210 | frame + walk 1 + both tails |
| `Remove_Rough_Terrain` | [Combat.c:22613](../../MoM/src/Combat.c#L22613) | `ovr154/CMB_RemoveRough.asm` | 181 | both nests, one gap at asm:75-95 |
| `Scatter_Terrain_Patches` | [Combat.c:23246](../../MoM/src/Combat.c#L23246) | `ovr154/Patch_Terrain_Group.asm` | 124 | **full body walk — faithful** |
| `Merge_Dirt_Patches` | [Combat.c:22576](../../MoM/src/Combat.c#L22576) | `ovr154/CMB_MergeDirt.asm` | 98 | **full body walk — faithful** |
