...
- [`Resolve_Wizard_Conquest`](CONQUEST-Resolve_Wizard_Conquest.md) — sole caller; plays `Win_Animation(_current_player_idx)` on the last-AI-eliminated branch (after `CP_Is_Dead`), before `End_Of_Game_Score` / `MAGIC.EXE`.
