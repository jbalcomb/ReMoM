...
| Pattern | `AI_Choose_War_Landmass` | `AI_Continent_Reeval__WIP` | `AI_SingleCont_Reeval__WIP` |
|---|---|---|---|
...
- [AIMOVE-AI_Continent_Reeval__WIP.md](AIMOVE-AI_Continent_Reeval__WIP.md) — full-rebuild classifier; reads _ai_landmass_war_targets in its Phase 14
