...
| `Pick_Target_For_City_Enchantment__WIP` | [AISPELL.c:3611](../../MoM/src/AISPELL.c#L3611) | Cast-time lookup (`switch(spell_idx) case spl_Flying_Fortress`) — returns the chosen city index for the actual cast. |
