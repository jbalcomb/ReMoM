...
[x]             |-> AI_Disband_To_Balance_Budget()
[x]             |-> AI_Shift_Off_Home_Plane()
[x]             |-> AI_Move_Out_Boats()
[x]             |-> AI_Find_Opportunity_City_Target()
...
[x]             |-> AI_Stacks_Do_Meld()
[x]             |-> AI_Stacks_Do_Settle()
[x]                 |-> AI_Stacks_Reorder_Settle_Elsewhere()
[x]                     |-> Next_Nearest_Ferry_Square()
[x]                     |-> Adjacent_Land_Square()
[x]                         |-> Square_Is_Land()
[x]             |-> AI_Stacks_Do_Purify()
[x]                 |-> AI_Stacks_Order_Purify()
[x]                 |-> AI_Stacks_Order_Attack_Target_Or_Goto_Destination()
[x]             |-> AI_Stacks_Do_RoadBuild()
[x]                 |-> AI_Stacks_Order_Attack_Target_Or_Goto_Destination()
[x]                 |-> AI_Stacks_Order_RoadBuild()
