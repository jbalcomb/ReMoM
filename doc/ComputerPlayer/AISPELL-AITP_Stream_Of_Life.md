...
| `AITP_City_Enchantment` | [AISPELL.c:3798](../../MoM/src/AISPELL.c#L3798) | Cast-time lookup (`switch(spell_idx) case spl_Stream_Of_Life`) — returns the chosen city index for the actual cast. |
