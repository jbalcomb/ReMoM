...
| `Pick_Target_For_City_Enchantment__WIP` | [AISPELL.c:3418](../../MoM/src/AISPELL.c#L3418) | Cast-time lookup (`switch(spell_idx) case spl_Earth_Gate`) — returns the chosen city index for the actual cast. |
