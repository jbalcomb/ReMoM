...
| `Pick_Target_For_City_Enchantment__WIP` | [AISPELL.c:3386](../../MoM/src/AISPELL.c#L3386) | Cast-time lookup (`switch(spell_idx) case spl_Move_Fortress`) — returns the chosen city index for the actual cast. |
