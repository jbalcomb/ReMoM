...
flowchart TD
    ...
    subgraph PhaseOrders["ORDER PHASE — AI_Set_Unit_Orders(player_idx)"]
        ...
        Slots4_7 --> OrderXxx["AI_Stacks_Order_Meld<br/>AI_Order_Settle<br/>AI_Order_Purify<br/>AI_Order_RoadBuild<br/>AI_Stacks_Order_Ferry<br/><br/>sets Status to the matching us_* value<br/>consumes _ai_own_stack_unit_list slot"]:::func
    end
