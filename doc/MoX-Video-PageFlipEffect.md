...
Combat_Cast_Apply_Spell_Effect+CB0               mov     [PageFlipEffect], 0
Combat_Cast_Apply_Spell_Effect+B52               mov     [PageFlipEffect], 0
...
Combat_Cast_Apply_Spell_Effect+B3D               mov     [PageFlipEffect], 3
Combat_Cast_Apply_Spell_Effect+C9B               mov     [PageFlipEffect], 3
