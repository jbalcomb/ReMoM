...
// ¿ C++ Name Mangled  extern SDL_Window * sdl3_window; ?
extern SDL_Window * sdl3_window;
extern SDL_Renderer * sdl3_renderer;
extern SDL_Surface * sdl3_surface_RGB666;
extern SDL_Surface * sdl3_surface_ARGB8888;
extern SDL_Texture * sdl3_texture;
extern SDL_Texture * sdl3_texture_upscaled;

extern char sdl3_window_title[];

extern SDL_Rect sdl3_blit_rect;

extern uint64_t sdl3_ticks_startup;
extern uint64_t sdl3_frame_count;
extern uint64_t sdl3_ticks_mark_time;
extern uint64_t sdl3_ticks_release_time;

extern uint64_t sdl3_performance_counter;


// MOM_PFL.H  extern SDL_Color platform_palette_buffer[256];
// extern bool sdl3_1oom_palette_to_set;

extern int sdl3_window_width;
extern int sdl3_window_height;
