...
// static int Platform_Translated_Key(SDL_Keysym * sdl3_keysym);
// static int Platform_Localized_Key(SDL_Keysym * sdl3_keysym);
// static int Platform_Typed_Character(SDL_Keysym * sdl3_keysym);
