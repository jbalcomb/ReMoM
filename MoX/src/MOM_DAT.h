...
#include "Input.h"
#include "MOM_DEF.h"    /* MAX_BATTLE_UNIT_SLOT_COUNT */
#include "Mouse.h"
#include "MOX_BASE.h"
#include "MOX_TYPE.h"
...
{
    scc_Summoning                     =  0, /* BOTH:    Air Elemental, Angel, Arch Angel, Basilisk, Behemoth, Chaos Spawn, Chimeras, Cockatrices, Colossus, Death Knights, Demon Lord, Djinn, Doom Bat, Earth Elemental, Efreet, Fire Elemental, Fire Giant, Floating Island, Gargoyles, Ghouls, Giant Spiders, Gorgons, Great Drake, Great Wyrm, Guardian Spirit, Hell Hounds, Hydra, Magic Spirit, Nagas, Night Stalker, Phantom Beast, Phantom Warriors, Shadow Demons, Skeletons, Sky Drake, Sprites, Stone Giant, Storm Giant, Unicorns, War Bears, Wraiths */
    scc_Unit_Enchantment              =  1, /* BOTH:    Berserk, Black Channels, Bless, Cloak of Fear, Elemental Armor, Endurance, Flight, Giant Strength, Guardian Wind, Haste, Immolation, Invisibility, Invulnerability, Iron Skin, Lionheart, Magic Immunity, Path Finding, Planar Travel, Regeneration, Resist Elements, Resist Magic, Righteousness, Spell Lock, Stone Skin, True Sight, Water Walking, Wind Walking, Wraith Form */
    scc_City_Enchantment_Positive     =  2, /* BOTH:    Altar of Battle, Astral Gate, Cloud of Shadow, Consecration, Dark Rituals, Earth Gate, Flying Fortress, Gaias Blessing, Heavenly Light, Inspirations, Natures Eye, Prosperity, Stream of Life, Summoning Circle, Wall of Darkness, Wall of Fire */
    scc_City_Enchantment_Negative     =  3, /* OVER:    Chaos Rift, Cursed Lands, Evil Presence, Famine, Pestilence */
    scc_Direct_Damage_Fixed           =  4, /* BOTH:    Doom Bolt, Fire Storm, Ice Storm, Star Fires, Warp Lightning */
    scc_Special_Spell                 =  5, /* BOTH:    Animate Dead, Black Wind, Call The Void, Change Terrain, Chaos Channels, Corruption, Cracks Call, Death Wish, Disrupt, Earth Lore, Earth to Mud, Earthquake, Enchant Road, Great Unsummoning, Healing, Incarnation, Lycanthropy, Magic Vortex, Move Fortress, Natures Cures, Plane Shift, Raise Dead, Raise Volcano, Recall Hero, Resurrection, Spell Binding, Spell Of Mastery, Spell Of Return, Spell Ward, Stasis, Summon Champion, Summon Hero, Transmute, Wall of Stone, Warp Creature, Warp Node, Warp Wood, Word of Recall */
    scc_Target_Wizard                 =  6, /* WZRD:    Cruel Unminding, Drain Power, Spell Blast, Subversion */
    /* DNE 7 */
    /* DNE 8*/
    scc_Global_Enchantment            =  9, /* OVER:    Armageddon, Aura of Majesty, Awareness, Chaos Surge, Charm of Life, Crusade, Detect Magic, Doom Mastery, Eternal Night, Evil Omens, Great Wasting, Herb Mastery, Holy Arms, Just Cause, Life Force, Meteor Storms, Natures Awareness, Natures Wrath, Planar Seal, Suppress Magic, Time Stop, Tranquility, Wind Mastery, Zombie Mastery */
    scc_Battlefield_Spell             = 10, /* CMBT:    Black Prayer, Blur, Call Chaos, Call Lightning, Darkness, Death Spell, Entangle, Flame Strike, High Prayer, Holy Word, Mana Leak, Mass Healing, Mass Invisibility, Metal Fires, Prayer, Terror, True Light, Warp Reality, Wrack */
    scc_Crafting_Spell                = 11,
    scc_Combat_Destroy_Unit           = 12, /* CMBT:    Disintegrate, Dispel Evil, Petrify, Word of Death */
    scc_Resistable_Spell              = 13, /* CMBT:    Black Sleep, Confusion, Creature Binding, Vertigo, Weakness */
    scc_Unresistable_Spell            = 14, /* CMBT:    Mind Storm, Web */
    scc_Unit_Enchantment_Normal_Only  = 15, /*          Eldritch Weapon, Flame Blade, Heroism, Holy Armor, Holy Weapon */
    scc_Mundane_Curse                 = 16, /* CMBT:    Possession, Shatter */
    /* DNE */ scc_Infusable_Spell     = 17, /* below, no slider, above, maybe slider */
    scc_Dispels                       = 18, /* CMBT:    Dispel Magic, Dispel Magic True */
    scc_Disenchants                   = 19, /* BOTH:    Disenchant Area, Disenchant True */
    scc_Disjunctions                  = 20, /* OVER:    Disjunction, Disjunction True */
    scc_Combat_Counter_Magic          = 21, /* CMBT:    Counter Magic; in with scc_Battlefield_Spell */
    scc_Direct_Damage_Variable        = 22, /* CMBT:    Fire Bolt, Fireball, Ice Bolt, Life Drain, Lightning Bolt, Psionic Blast */
    scc_Combat_Banish                 = 23  /* CMBT:    Banish */
};
...
enum e_COMBAT_NODE_TYPE
{
    ...
    cnt_Nature    =  1,  /* <-> rt_Nature */
    cnt_Chaos     =  2   /* <-> rt_Chaos */
};
...
struct s_SPELL_DATA
{
    ...
    */
    union
    {
        ...
        struct {
            /* 20 */  int8_t cmbt_ench_idx;     /* index into combat_enchantments */
        };
        struct {
...
struct s_LAIR
{
    ...
    /* 0F */  uint8_t  Misc_Flags; // 7: 6: 5: 4: 3: 2: ¿ attacked ? 1: ¿ visited ? 0: Surveyor {"Unexplored", }Prisoner {F,T}  ... Create_Lair() sets 1 for prisoner, Lair_Generate_Treasure() does Test_Bit_Field()
...
// WZD dseg:913A
extern SAMB_ptr _prefab_item_table;
...
// WZD dseg:9448 00 00                                           g_first_research_page dw 0                 ; DATA XREF: G_WLD_StaticAssetRfrsh+67w ...
...
// WZD dseg:9CB8
extern uint8_t * _map_square_terrain_specials;          // alloc in Allocate_Data_Space()
...
// WZD dseg:C040
// MainScr  extern int16_t CRP_OverlandVar_4;
// WZD dseg:C042
// MainScr  extern int16_t OVL_MapVar3;
// WZD dseg:C044
// MainScr  extern int16_t CRP_OVL_Obstacle_Var1;
...
// WZD dseg:C064
// MainScr  extern int16_t CRP_OverlandVar_3;
...
// WZD dseg:C9D4
extern int16_t _scroll_text_min_height;
// WZD dseg:C9D6
...
// WZD dseg:E5D2 00 00                                           farload_extended_flag dw 0                 ; DATA XREF: LBX_Load_Entry:loc_159F1r ...
