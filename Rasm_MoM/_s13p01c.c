...
// - --- - --- - --- - --- - --- - --- - --- - --- - --- - --- - --- - --- -
    ...
    else
    {
        ...
        g_EmmHndlNbr_YOMOMA = EMM_GetOrCreateHandle(1, g_EmmHndlNm_YOMOMA2, 0);
    }
...
// - --- - --- - --- - --- - --- - --- - --- - --- - --- - --- - --- - --- -
    ...
    g_EmmHndlNbr_VGAFILEH = EMM_GetOrCreateHandle(5, g_EmmHndlNm_VGAFILEH, 1);
    g_EmmHndlNbr_EMMDATAH = EMM_GetOrCreateHandle(4, g_EmmHndlNm_EMMDATAH, 1);
