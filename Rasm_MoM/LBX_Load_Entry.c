...
unsigned int LBX_Load_Entry(char *argLbxName, int argLbxEntry, sgmt_addr argSAMBhead, int argLoadType, int argFormatType)
{
    ...
    printf("DEBUG: BEGIN: LBX_Load_Entry()\n");
    ...
    printf("DEBUG: END: LBX_Load_Entry()\n");
    return varSAMBdata;
}
